package com.andres.insulinicpump.view.controller;

import com.andres.insulinicpump.view.model.*;
...
public class RestControllerUi {
    ...
    public void insertDeviceData(
            ...
            @RequestParam(value = "deliveredInsulin") Integer deliveredInsulin
    ){
